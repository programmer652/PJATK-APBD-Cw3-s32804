...
public sealed class ZadaniaLinq
{
    ...
    {
        return DaneUczelni.Studenci.OrderBy(s => s.Nazwisko).ThenBy(s => s.Imie).Select(s => s.NumerIndeksu + " " + s.Imie + " " + s.Nazwisko);
    }
    ...
    public IEnumerable<string> Zadanie04_PierwszyPrzedmiotAnalityczny()
    {
        return new[]
        {
            DaneUczelni.Przedmioty
                ...
                .FirstOrDefault() ?? "Nie istnieje taki przedmiot"
        };
    }
    ...
    public IEnumerable<string> Zadanie05_CzyIstniejeNieaktywneZapisanie()
    {
        return new[]
        {
            "Czy w danych uczelni istnieje przynajmniej jeden nieaktywny zapis? => " +
            DaneUczelni.Zapisy.Any(z => z.CzyAktywny == false)
        };
    }
    ...
    {
        foreach(Prowadzacy p in DaneUczelni.Prowadzacy)
            Console.WriteLine(p.Katedra);
        return new[]
        {
            "Czy każdy prowadzący ma uzupełnioną nazwę katedry? => " 
            + DaneUczelni.Prowadzacy.All(p => p.Katedra != "")
        };
    }
    ...
    public IEnumerable<string> Zadanie07_LiczbaAktywnychZapisow()
    {
        return new[]
        {
            "Aktywnych zapisów znajduje się w systemie: " 
    ...
    {
        return DaneUczelni.Studenci.Select(s => s.Miasto).Distinct().OrderBy(miasto => miasto);
    }
    ...
    {
        return DaneUczelni.Zapisy.OrderByDescending(zapis => zapis.DataZapisu).Take(3).Select(z =>
            "trzy najnowsze zapisy na przedmioty:" + z.DataZapisu + z.StudentId + z.PrzedmiotId);
    }
    ...
    public IEnumerable<string> Zadanie12_ParyStudentPrzedmiot()
    {
        return DaneUczelni.Zapisy
            ...
            .SelectMany(
                zs => DaneUczelni.Przedmioty.Where(p => p.Id == zs.Zapis.PrzedmiotId),
    ...
    public IEnumerable<string> Zadanie13_GrupowanieZapisowWedlugPrzedmiotu()
    {
        return DaneUczelni.Zapisy
            .Join(
                ...
                (zapis, przedmiot) => new { zapis, przedmiot.Nazwa }
            )
            .GroupBy(x => x.Nazwa)
    ...
    public IEnumerable<string> Zadanie14_SredniaOcenaNaPrzedmiot()
    {
        return DaneUczelni.Zapisy
            ...
            .Join(DaneUczelni.Przedmioty,
                z => z.PrzedmiotId,
                p => p.Id,
                (z, p) => new { z.OcenaKoncowa, p.Nazwa })
            .GroupBy(x => x.Nazwa)
            .Select(g => $"{g.Key} | Średnia ocena: {g.Average(x => x.OcenaKoncowa.Value):F2}");
    }
    ...
    {
        return DaneUczelni.Przedmioty.Join(
                DaneUczelni.Prowadzacy,
                p => p.ProwadzacyId,
                prow => prow.Id,
                (p, prow) => new { p.Nazwa, p.ProwadzacyId, prow.Imie, prow.Nazwisko }
            ).GroupBy(g => g.ProwadzacyId)
            .Select(g => $"{g.First().Imie} {g.First().Nazwisko} | {g.Count()}");
    }
    ...
    public IEnumerable<string> Zadanie16_NajwyzszaOcenaKazdegoStudenta()
    {
        return DaneUczelni.Zapisy
            ...
            .Join(DaneUczelni.Studenci,
                z => z.StudentId,
                s => s.Id,
                (z, s) => new {s.Id, s.Imie, s.Nazwisko, z.OcenaKoncowa})
            .GroupBy(x => x.Id)
            .Select(g => $"{g.First().Imie} {g.First().Nazwisko} | Najwyższa ocena: {g.Max(x => x.OcenaKoncowa.Value):F2}");
    }
    ...
    public IEnumerable<string> Wyzwanie01_StudenciZWiecejNizJednymAktywnymPrzedmiotem()
    {
        return DaneUczelni.Zapisy.Join(DaneUczelni.Studenci,
            z => z.StudentId,
            s => s.Id,
            (z, s) => new {s.Id, s.Imie, s.Nazwisko, z.CzyAktywny})
            .GroupBy(g => g.Id)
            .Where(g => g.Count(x => x.CzyAktywny) > 1)
            .Select(g => $"{g.First().Imie} {g.First().Nazwisko} | {g.Count(x => x.CzyAktywny)}");
    }
    ...
    public IEnumerable<string> Wyzwanie02_PrzedmiotyStartujaceWKwietniuBezOcenKoncowych()
    {
        return DaneUczelni.Zapisy.Join(DaneUczelni.Przedmioty,
                z => z.PrzedmiotId,
                p => p.Id,
                (z, p) => new { z.OcenaKoncowa, p.DataStartu, p.Nazwa })
            .Where(x => x.OcenaKoncowa == null & x.DataStartu.Month == 4 & x.DataStartu.Year == 2026)
            .Select(x => x.Nazwa).Distinct();
    }
    ...
    public IEnumerable<string> Wyzwanie03_ProwadzacyISredniaOcenNaIchPrzedmiotach()
    {
        return DaneUczelni.Prowadzacy
            .GroupJoin(
                ...
                (prow, przedmioty) => new { prow, przedmioty }
            )
            .Select(g => new 
            { 
                g.prow, 
            ...
            .Select(g =>
                g.prow.Imie + " " + g.prow.Nazwisko + " " +
                (g.oceny.Any() ? g.oceny.Average().ToString("F2") : "brak")
            );
    }
    ...
    public IEnumerable<string> Wyzwanie04_MiastaILiczbaAktywnychZapisow()
    {
        return DaneUczelni.Studenci.Join(
            ...
            .Select(g => g.First().Miasto + " " + g.Count());
    }
